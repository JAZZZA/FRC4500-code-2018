...
public class RobotMap {
	public static double gyroFactor = 1.04;
	...
	// Solenoids
	public static int topClawOne1 = 0,// Dummy
			topClawOne2 = 1,// Dummy
			topClawTwo1 = 2,// Dummy
			topClawTwo2 = 3;// Dummy

	// Encoder, not sure if digital or analog slots
	public static int screwDriveEncoder1 = 0,// Dummy
			screwDriveEncoder2 = 1;// Dummy

	// Bottom Claw Encoder Values
	public static int bottomClawClosed = 100,// Dummy
			bottomClawOpen = 0; // Dummy

	// Encoder For elevator winch
	public static int winchDriveEncoder1 = 0, winchDriveEncoder2 = 1;

	// Elevator Winch Encoder set down and pick up values
	public static int winchBottom = 0,// Dummy
	...
	public static double robotRotSpeed = 411;// The rotational rate of the robot
												// at full twist in degrees per
												// second

	public static double screwSpeed = 0.5; // Dummy / Half Speed = .5 Full Speed = 1	
