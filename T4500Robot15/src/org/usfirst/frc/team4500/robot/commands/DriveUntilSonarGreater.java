 ...
 *
 */
public class DriveUntilSonarGreater extends Command {
	 ...
	 *            (motor speed 0 - 1)
	 */
	public DriveUntilSonarGreater(double proximity, double speed) {
	 ...
	 */
	public DriveUntilSonarGreater(double proximity, double speed, double angle) {
		requires(Robot.drivetrain);
		this.proximity = proximity;
		this.speed = speed;
		this.angle = angle;
